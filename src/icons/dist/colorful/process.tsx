  ...
  >
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <g transform="translate(1.648 2.38)">
        ...
        />
        <mask id="process_svg__f" fill="#fff">
          <use xlinkHref="#process_svg__c" />
        </mask>
        <rect
          width={29.5}
          height={27.5}
        ...
        <g mask="url(#process_svg__f)">
          <g transform="translate(6.852 13.35)">
            ...
            />
            <use xlinkHref="#process_svg__g" fill="#FFF" />
          </g>
          <g transform="translate(6.852 13.35)">
            <use
            ...
            />
            <use xlinkHref="#process_svg__i" fill="#FFF" />
          </g>
        </g>
      </g>
    </g>
